...
[![Build Status](https://github.com/nedog/devops-capstone-project/actions/workflows/ci-build.yml/badge.svg)](https://github.com/nedog/devops-capstone-project/actions/workflows/ci-build.yml)
...
![Build Status](https://github.com/<OWNER>/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)These labs are designed to be executed in the IBM Developer Skills Network Cloud IDE with OpenShift. Please use the links provided in the Coursera Capstone project to access the lab environment.
